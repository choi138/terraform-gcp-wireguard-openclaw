...
Define the internal Ops API requirements for dashboard reads, conversation visibility, infra status access, and audit-aware operator access over private network paths.
